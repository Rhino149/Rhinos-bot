...
.setAuthor(oldMessage.author.tag, oldMessage.author.avatarURL)
  ...
  .setFooter(oldMessage.author.id)
	 oldMessage.guild.channels.get(channelMention[1]).send(embed).catch(console.error) || oldMessage.guild.channels.find(c => c.name === settings.messageLogChannel).send(embed).catch(console.error)
