...
exports.run = (client, message, args) => {
  ...
  let inviteLink = message.client.config.inviteURL || `https://discordapp.com/oauth2/authorize?client_id=636311667239551006&scope=bot&permissions=2146958847`;    if(args[0] && args[0] === "copy"){
