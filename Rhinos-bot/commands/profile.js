...
const bank = client.money.get(member.id, 'bank')
  ...
  .addField(`${member.displayName}'s Wallet:`, `$${Number(money).toLocaleString('en')}`, inline = true)
  .addField(`${member.displayName}'s Bank:`, `$${Number(bank).toLocaleString('en')}`, inline = true)
